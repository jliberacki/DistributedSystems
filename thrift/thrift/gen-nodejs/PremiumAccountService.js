...
PremiumAccountService_getLoanDetails_result.prototype.write = function(output) {
  ...
  if (this.missingArgumentException !== null && this.missingArgumentException !== undefined) {
    output.writeFieldBegin('missingArgumentException', Thrift.Type.STRUCT, 3);
...
PremiumAccountServiceClient.prototype.getLoanDetails = function(pesel, loanParameters, callback) {
  ...
  if (callback === undefined) {
    ...
    this.send_getLoanDetails(pesel, loanParameters);
...
PremiumAccountServiceClient.prototype.send_getLoanDetails = function(pesel, loanParameters) {
...
PremiumAccountServiceProcessor.prototype.process_getLoanDetails = function(seqid, input, output) {
  ...
  if (this._handler.getLoanDetails.length === 2) {
    Q.fcall(this._handler.getLoanDetails.bind(this._handler),
      args.pesel,
      args.loanParameters
      ...
      var result;
      if (err instanceof ttypes.AuthorizationException || err instanceof ttypes.InvalidArgumentException || err instanceof ttypes.MissingArgumentException) {
    ...
    this._handler.getLoanDetails(args.pesel, args.loanParameters, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof ttypes.AuthorizationException || err instanceof ttypes.InvalidArgumentException || err instanceof ttypes.MissingArgumentException) {
